	...
	
{
   ...
   /**
    * Construye un AVLTree y le añade todos los elementos del AVLTree pasado por parametro
    * @param tree AVLTree  con los elementos a añadir
    */
    ...
    */
	...
	/**
	 * Devuelve true si se añaden correctamente todos los elementos de c 
	 */
